...
namespace Entity {
    ...
    public class Tile : MonoBehaviour {
        ...
        private void FlipColor() {
            ...
            if (IsInverted) {
                innerColor = GameCache.Instance.TileColor.StandardColor;
            } else {
                innerColor = GameCache.Instance.TileColor.InvertedColor;
            }

            IsInverted = !IsInverted;
            SetColor(GameCache.Instance.TileColor.BorderColor, innerColor);
        }
        #endregion
    }
}
