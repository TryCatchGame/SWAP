...
namespace Michsky.UI.ModernUIPack
{
    public class RadialSlider : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
    {
        ...
        [Header("OBJECTS")]
        [SerializeField]
        private Image sliderImage = default;
        [SerializeField]
        private Transform indicatorPivot = default;
        [SerializeField]
        ...
        [SerializeField]
        private bool rememberValue = true;
        [SerializeField]
        private bool enableCurrentValue = true;
        [SerializeField]
        private UnityEvent onValueChanged = default;
